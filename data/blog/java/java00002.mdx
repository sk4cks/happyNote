...
> <span style={{color: 'red'}}><b><span className="underline">실제 값</span> 만을 저장하는 공간으로 스택 메모리 영역에 저장됩니다.</b></span><br/>
...
<div style={{overflow: 'auto', width: '100%'}}>
    <table style={{width: '100%', border: 'darkgray'}} border="1" data-ke-style="style3" data-ke-align="alignLeft">
        <tbody>
            ...
            <tr style={{height: '19px'}}>
                <td style={{width: '21.0466%', height: '19px', padding: '0.5em'}}>short</td>
                <td style={{width: '26.9767%', height: '19px'}}>2 byte</td>
                <td style={{width: '16.3953%', height: '19px'}}>0</td>
            </tr>
            <tr style={{height: '19px'}}>
                <td style={{width: '21.0466%', height: '19px', padding: '0.5em'}}>int</td>
                <td style={{width: '26.9767%', height: '19px'}}>4 byte</td>
                <td style={{width: '16.3953%', height: '19px'}}>0</td>
            </tr>
            <tr style={{height: '19px'}}>
                <td style={{width: '21.0466%', height: '19px', padding: '0.5em'}}>long</td>
            ...
            <tr style={{height: '19px'}}>
                <td style={{width: '21.0466%', height: '19px', padding: '0.5em'}}>double</td>
                <td style={{width: '26.9767%', height: '19px'}}>8 byte</td>
...
> <span style={{color:'red'}}><b>스택에 저장되어 있는 <span className="underline">실제 값의 주소</span>를 저장하는 곳으로 힙 메모리 영역에 저장됩니다.</b></span><br/>
    ...
    <table style={{width: '100%', border: 'darkgray'}} border="1" data-ke-align="alignLeft">
        <tbody>
            ...
            <tr style={{height: '19px'}}>
                ...
                <td style={{width: '19.4186%', height: '76px'}} rowSpan="4"><span style={{backgroundColor: '#ffffff'}}>Null</span></td>
