...
<img src="/static/images/springBoot/image00000011.png" />
...
<img src="/static/images/springBoot/image00000012.png" />
...
<img src="/static/images/springBoot/image00000013.png" />
...
<br/><br/>
  ...
  - **Cipher 초기화하기**
    ...
    <img src="/static/images/springBoot/image00000014.png" />
...
- **MAC(Message Authentication Code)**
  ...
  <img src="/static/images/springBoot/image00000015.png" />
...
- RSA (Ron <span style={{color: 'red'}}>R</span>ivest, Adi <span style={{color: 'red'}}>S</span>hamir, Leonard <span style={{color: 'red'}}>A</span>dleman 세 사람의 성을 따서 RSA 라고 이름이 붙은 암호 방식)
  ...
  <img src="/static/images/springBoot/image00000016.png" />
...
### ✓ Key 계층 구조
<img src="/static/images/springBoot/image00000017.png" />
...
<img src="/static/images/springBoot/image00000018.png" />
...
<img src="/static/images/springBoot/image00000019.png" />
...
<img src="/static/images/springBoot/image00000020.png" />

### ✓ JWT
<img src="/static/images/springBoot/image00000021.png" />
<img src="/static/images/springBoot/image00000022.png" />
...
### ✓ JWK 구조
<img src="/static/images/springBoot/image00000023.png" />
...
- 구현체로서 **RSAKey, OctetSequenceKey, ECKey, OctetKeyPair** 가 있다
  <img src="/static/images/springBoot/image00000024.png" />

### ✓ JWKGenerator`<T extends JWK>`
<img src="/static/images/springBoot/image00000025.png" />
...
- **토큰 검증에 대한 다양한 케이스의 테스트를 위해 두 가지 방식으로 토큰 발행 및 검증을 진행하도록 한다.**<br/>
  ...
  <img src="/static/images/springBoot/image00000026.png" />
...
<img src="/static/images/springBoot/image00000027.png" />
...
- 리소스 서버 설정 클래스로서 인가서버 엔드포인트인 JwkSetUri 방식에 의한 RSA 인증 및 인가 처리 설정을 한다
  <img src="/static/images/springBoot/image00000028.png" />
...
- JwtAuthenticationToken 의 principal 에 저장되어 있는 Jwt 객체를 바로 참조할 수 있다
  <img src="/static/images/springBoot/image00000029.png" />

# 5. BearerTokenAuthenticationFilter
<img src="/static/images/springBoot/image00000030.png" />
