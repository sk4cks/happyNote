...
<img src={`${process.env.BASE_PATH}/static/images/springBoot/image00000002.png`} />
...
<img src={`${process.env.BASE_PATH}/static/images/springBoot/image00000003.png`} />

# 4. 자동설정에 의한 초기화 과정

<img src={`${process.env.BASE_PATH}/static/images/springBoot/image00000004.png`} />
