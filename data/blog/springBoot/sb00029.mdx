...
<img src={`${process.env.BASE_PATH}/static/images/springBoot/image00000031.png`} />
...
<img src={`${process.env.BASE_PATH}/static/images/springBoot/image00000032.png`} />

- 리소스 서버는 각 스코프에 “SCOPE_” 프리픽스를 달아 승인된 권한 리스트를 만든다.
- JWT의 scope로 특정 엔드포인트나 메소드를 보호하려면, 프리픽스를 포함한 적절한 표현식을 사용해야 한다
<br/><br/>

<img src={`${process.env.BASE_PATH}/static/images/springBoot/image00000033.png`} />
...
<img src={`${process.env.BASE_PATH}/static/images/springBoot/image00000034.png`} />