...
date: 2024-05-27
tags: ['java', 'springboot', 'window']
draft: false
summary: 'winsw를 이용한 Spring Boot 서비스 윈도우에서 등록하는 방법'
layout: PostSimple
---

# winsw Download
* [https://www.baeldung.com/spring-boot-app-as-a-service](https://www.baeldung.com/spring-boot-app-as-a-service) 접속
