...
<img src={`${process.env.BASE_PATH}/static/images/springBoot/image00000035.png`} />
<br/><br/>

# 2. 토큰 검사 및 프로세스 이해

<img src={`${process.env.BASE_PATH}/static/images/springBoot/image00000036.png`} />
...
<img src={`${process.env.BASE_PATH}/static/images/springBoot/image00000037.png`} />
